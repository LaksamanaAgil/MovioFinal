package com.laksamana.movio.movie.data.mapper_impl
...
import com.laksamana.movio.utils.GenreConstants

class MovieApiMapperImpl : ApiMapper<List<Movie>, MovieDto> { //TODO: Implementasi dari mapper API
