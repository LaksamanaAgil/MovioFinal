...
object MovieDetailModule {
    ...
    @Provides
    @Singleton
    fun provideMovieDetailRepository( //TODO: Penyediaan repository khusus halam detail film, dengan interface API yang digunakan, Dto dan data class untuk transfer data dari API, serta Mapper untuk pemetaan arus data dari API
